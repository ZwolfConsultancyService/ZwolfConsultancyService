      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 text-base">
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li>
              <Link to="/" className="hover:text-[#5aa6f8]">
                Home
              </Link>
            </li>
            <li>
              <Link to="/about" className="hover:text-[#5aa6f8]">
                About Us
              </Link>
            </li>
            <li>
              <Link to="/services" className="hover:text-[#5aa6f8]">
                Services
              </Link>
            </li>
            <li>
              <Link to="/blog" className="hover:text-[#5aa6f8]">
                Blog
              </Link>
            </li>
            <li>
              <Link to="/contact" className="hover:text-[#5aa6f8]">
                Contact
              </Link>
            </li>
          </ul>
