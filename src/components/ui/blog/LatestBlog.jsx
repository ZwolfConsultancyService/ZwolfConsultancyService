...
//           <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-10">
//             <div>
//               <p className="text-[#5aa6f8] font-medium mb-2">Latest Blog & Articles</p>
//               <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
//                 The latest insights you need to know
//               </h2>
//             </div>
...
//         <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-10">
//           <div>
//             <p className="text-[#5aa6f8] mb-2">Latest Blog & Articles</p>
//             <h2 className="text-3xl sm:text-4xl text-gray-900">
//               The latest insights you need to know
//             </h2>
//           </div>
...
const LatestBlog = () => {
  ...
  const fetchLatestBlogs = async () => {
    try {
      ...
      setBlogs(blogsData.slice(0, LATEST_BLOGS_COUNT));
    } catch (error) {
      console.error("Error fetching blogs:", error.message);
      setError(error.message);
    } finally {
