...
//   const getPreviousBlog = () => {
//     if (!blog || allBlogs.length === 0) return null;
//     const currentIndex = allBlogs.findIndex((b) => b.title === blog.title);
//     return currentIndex > 0 ? allBlogs[currentIndex - 1] : null;
//   };
...
//   const handleNavigation = (targetBlog) => {
//     if (!targetBlog) return;
//     const slug = createSlug(targetBlog.title);
//     sessionStorage.setItem("selectedBlog", JSON.stringify(targetBlog));
//     navigate(`/blogs/${slug}`);
...
//   const shareOnLinkedIn = () => {
//     window.open(`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(getCurrentPageUrl())}`, "_blank");
//   };

//   const shareOnWhatsApp = () => {
//     const text = `Check out this article: "${blog.title}" - ${getCurrentPageUrl()}`;
//     window.open(`https://wa.me/?text=${encodeURIComponent(text)}`, "_blank");
//   };

//   const shareOnFacebook = () => {
//     window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(getCurrentPageUrl())}`, "_blank");
//   };
...
//             </div>
//             <div className="flex flex-wrap gap-3">
//               <button onClick={shareOnTwitter} className="flex items-center bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition-colors duration-200">
//                 <FaTwitter className="mr-2" /> Twitter
//               </button>
//               <button onClick={shareOnLinkedIn} className="flex items-center bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-800 transition-colors duration-200">
//                 <FaLinkedin className="mr-2" /> LinkedIn
//               </button>
//               <button onClick={shareOnWhatsApp} className="flex items-center bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors duration-200">
//                 <FaWhatsapp className="mr-2" /> WhatsApp
//               </button>
//               <button onClick={shareOnFacebook} className="flex items-center bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200">
//                 <FaFacebook className="mr-2" /> Facebook
//               </button>
//               <button onClick={copyToClipboard} className="flex items-center bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors duration-200">
...
const BlogDetail = () => {
  ...
  useEffect(() => {
    const loadBlogData = async () => {
      try {
        ...
        const blogs = parseBlogs(response.data);
        if (blogs) {
          setAllBlogs(blogs);
          if (storedBlog) {
            const blogData = JSON.parse(storedBlog);
            const fullBlogData = blogs.find((b) => b.title === blogData.title);
            if (fullBlogData) setBlog(fullBlogData);
          }
        }
      } catch (error) {
        console.error("Failed to load blog data:", error);
  ...
  return (
    <div className="bg-white">
      ...
      {/* Content + Share + Navigation */}
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">

        {/* ✅ Blog HTML Content - sab tags properly render honge */}
        <div
          className="
            ...
            [&_h5]:text-base [&_h5]:font-semibold [&_h5]:text-gray-900 [&_h5]:mt-4 [&_h5]:mb-2
            [&_h6]:text-sm [&_h6]:font-semibold [&_h6]:text-gray-700 [&_h6]:mt-4 [&_h6]:mb-2
            [&_p]:text-gray-700 [&_p]:leading-relaxed [&_p]:mb-4 [&_p]:text-base
            [&_a]:text-blue-600 [&_a]:underline [&_a]:font-medium [&_a]:cursor-pointer
            hover:[&_a]:text-blue-800 [&_a]:transition-colors [&_a]:break-words
            ...
            [&_i]:italic [&_i]:text-gray-700
            [&_u]:underline
            [&_s]:line-through [&_s]:text-gray-500
            [&_blockquote]:border-l-4 [&_blockquote]:border-blue-500 [&_blockquote]:pl-6
            [&_blockquote]:italic [&_blockquote]:text-gray-600 [&_blockquote]:my-6
            [&_blockquote]:bg-blue-50 [&_blockquote]:py-3 [&_blockquote]:rounded-r-lg
            [&_img]:rounded-xl [&_img]:max-w-full [&_img]:my-6 [&_img]:mx-auto [&_img]:block [&_img]:shadow-md
            [&_figure]:my-6 [&_figcaption]:text-center [&_figcaption]:text-gray-500 [&_figcaption]:text-sm [&_figcaption]:mt-2
            [&_table]:w-full [&_table]:border-collapse [&_table]:my-6 [&_table]:rounded-lg [&_table]:overflow-hidden
            [&_thead]:bg-gray-100
            [&_th]:border [&_th]:border-gray-300 [&_th]:px-4 [&_th]:py-3 [&_th]:text-left [&_th]:font-semibold [&_th]:text-gray-900
            [&_td]:border [&_td]:border-gray-200 [&_td]:px-4 [&_td]:py-3 [&_td]:text-gray-700
            [&_tr:hover]:bg-gray-50
            [&_hr]:border-gray-200 [&_hr]:my-8
            [&_code]:bg-gray-100 [&_code]:px-2 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-sm [&_code]:text-pink-600 [&_code]:font-mono
