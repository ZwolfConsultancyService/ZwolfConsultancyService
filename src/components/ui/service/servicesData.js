...
export const serviceLocations = [
  ...
  // ───── SOUTH DELHI — SOUTH-EAST AREAS ─────
  "Kalkaji",
  "Nehru Place",
  "Nehru Place Extension",
  "Govindpuri",
  "Tughlakabad",
...
export const servicesData = [
  {
    ...
    detailedDescription:
  "Your website is more than a digital address — it's your brand's voice, your customer's first impression, and your most powerful sales tool. In a market where over 90% of buying journeys start with a Google search, a slow, outdated, or poorly structured website doesn't just look bad — it actively costs you customers before you ever get a chance to speak to them. We design and develop websites that are visually stunning, lightning-fast, secure, and built from the ground up to convert visitors into paying customers, not just page views. Every project begins with understanding your business, your audience, and your competitors, so the end result isn't a generic template — it's a website engineered around how your specific customers search, browse, and decide. From clean, conversion-focused UI/UX and mobile-first responsive design, to solid technical SEO foundations, fast load times, and secure, scalable code, we handle every layer that determines whether a visitor stays or bounces. Whether you're a startup building your first digital presence, a growing SME looking to scale online, or a large enterprise that needs a robust, secure, and easily manageable platform, we ensure your website works as hard as your best salesperson — every hour of every day, across every device.",
    icon: FaCode,
    image:
