...
const ServiceLocationDetail = () => {
  ...
  if (parts.length !== 2) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <Helmet>
          <title>Page Not Found | Zwolf Consultancy</title>
  ...
  if (!service) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <Helmet>
          <title>Service Not Found | Zwolf Consultancy</title>
          <meta name="robots" content="noindex, nofollow" />
        </Helmet>
        <div className="text-center max-w-2xl mx-auto p-8">
          <div className="bg-red-50 text-red-600 p-4 rounded-full w-20 h-20 mx-auto mb-6 flex items-center justify-center">
  ...
  if (!locationMatch) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <Helmet>
          <title>Location Not Found | Zwolf Consultancy</title>
          <meta name="robots" content="noindex, nofollow" />
        </Helmet>
        <div className="text-center max-w-2xl mx-auto p-8">
          <div className="bg-red-50 text-red-600 p-4 rounded-full w-20 h-20 mx-auto mb-6 flex items-center justify-center">
  ...
  // Generate SEO data
  const seoTitle = `${service.title} in ${locationMatch} | Zwolf Consultancy`;
  const seoDescription = `Zwolf Consultancy is a leading ${service.title} provider in ${locationMatch}. We build SEO-friendly, fast and lead-generating solutions for local businesses. Contact us today.`;
  const seoKeywords = `${service.title} in ${locationMatch}, ${service.title.replace('Company', 'Provider')} in ${locationMatch}, ${service.category} in ${locationMatch}, Zwolf Consultancy`;
  const canonicalUrl = `https://zwolfconsultancy.com/${serviceSlug}-in-${locationSlug}`;
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Helmet>
        ...
        <meta property="og:site_name" content="Zwolf Consultancy" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "name": `Zwolf Consultancy - ${service.title}`,
            "image": "https://zwolfconsultancy.com/logo.png",
            "description": seoDescription,
            "address": {
              "@type": "PostalAddress",
              "addressLocality": locationMatch,
              "addressCountry": "IN"
            },
            "telephone": "+919520989744",
            "email": "zwolfconsultancy@gmail.com",
            "priceRange": "$$",
            "areaServed": {
              "@type": "City",
              "name": locationMatch
            ...
            "itemListElement": [
              {
                ...
                "position": 1,
                "name": "Home",
                "item": "https://zwolfconsultancy.com/"
              },
              {
                "@type": "ListItem",
                "position": 2,
                "name": "Services",
                "item": "https://zwolfconsultancy.com/services"
              },
              {
                "@type": "ListItem",
                "position": 3,
                "name": service.title,
                "item": `https://zwolfconsultancy.com/services/${service.slug}`
              },
              {
                "@type": "ListItem",
                "position": 4,
