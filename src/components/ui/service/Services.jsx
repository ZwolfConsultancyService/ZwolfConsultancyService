    ...
    <>
      ...
      <section className="bg-gradient-to-b from-white to-[#f9fbff] mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {servicesData.map((service, index) => {
              // Only index Website Development and SEO Services
              // All other services will have noindex, follow
              const shouldNotIndex = service.slug !== "website-development-company" && service.slug !== "seo-services-company";
